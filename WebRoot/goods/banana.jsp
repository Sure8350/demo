...
<head>
  ...
  <body>
  	<table id="tab" class="easyui-datagrid" toolbar="#tb" striped="true" singleSelect="true" url="${pageContext.request.contextPath}/goods/banana" fit=true title="香蕉">
  		<thead>
  			<tr>
  	...
  	<div id="num" style="display:none; padding: 10px">
    	<form id="frmNum" method="post">
	    	选择数量:<input name="number" required="true" class="easyui-textbox" style="width:100px"/><br/>
